...
exports.dbSendOneBack=function(table,data,db,callback){
	var datas = db.db("banandata");
	var collection = datas.collection(table);
	$sender=true;
	collection.insertOne(data, function(err, result){
...
exports.dbUpdateCallbackMore = function (table, dataFilter, dataUpdate, db, callback) {

    var datas = db.db("banandata");
    var collection = datas.collection(table);

    collection.updateMany(dataFilter, { $set: dataUpdate },function (err, result) {
        callback(result, err);
    });
...
exports.deleteData=function(table,data,db){
	var datas = db.db("banandata");
	var collection = datas.collection(table);
